...
- `RUNBOOK.Infrastructure_Operations_Baseline_Экостройконтинент_v0.2.md` - текущий operations runbook: VM, compose, deploy, health/readiness, smoke, CDN, runner, logs, backups, SSH hardening.
