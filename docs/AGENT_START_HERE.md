...
- R1 PRD/Blueprint drafts are created; next step is review with internal telemetry as operational truth and Metrica as optional external mirror, then approve privacy/bridge architecture.
