    ...
    >
      <div className={styles.stack}>
        <SurfacePacket
          ...
          summary="Эта страница только проверяет связность и конфигурацию. Она не меняет контент, не публикует и не открывает публичную ИИ-поверхность."
          bullets={[
            "Доступна только суперадмину.",
            "Проверяет базовый LLM-контур через внутреннюю проверку структурированного вывода.",
            "Проверяет SOCKS5-транспортный путь тем же внутренним фасадом.",
