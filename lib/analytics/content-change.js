...
export function resolveAttributionSafety({
  ...
  // Attribution safety prevents false before/after causality. Mixed content or
  // tracking changes must never become single-cause claims. See read model contract.
  if (!hasKnownChange) {
    return {
