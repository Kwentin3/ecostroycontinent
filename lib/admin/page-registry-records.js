...
export function normalizePageRegistryRecord(record = {}) {
  const pageType = typeof record?.metadata?.pageType === "string" && record.metadata.pageType.length > 0
    ? record.metadata.pageType
    : "about";
  const slug = typeof record?.slug === "string" && record.slug.length > 0
    ...
    : (typeof record?.metadata?.slug === "string" && record.metadata.slug.length > 0
        ...
        : (pageType === "home" ? "home" : pageType === "contacts" ? "contacts" : pageType === "about" ? "about" : ""));
