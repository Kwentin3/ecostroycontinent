...
import { normalizeLegacyPageCopy, normalizeLegacyPagePayload } from "../content-core/page-copy.js";
...
function readPageEditorValue(revision = null) {
  const payload = revision?.payload && typeof revision.payload === "object"
    ? normalizeLegacyPagePayload(revision.payload)
    : {};
  ...
  return {
    ...
    ctaTitle: normalizeLegacyPageCopy(ctaBlock?.title || ""),
    ctaBody: ctaBlock?.body || "",
    defaultBlockCtaLabel: normalizeLegacyPageCopy(ctaBlock?.ctaLabel || "")
  };
}
