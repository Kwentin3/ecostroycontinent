...
// Canonical names are owned by the Tracking Plan; update docs and tests before renaming.
...
// contact_journey_created is system/domain-only and must never be accepted from Public UI.
