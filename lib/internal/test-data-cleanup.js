...
// Sticky cleanup rule:
// temporary entities should be named with a `test__...` prefix at creation time.
// Keep matcher coverage explicit so future cleanup can separate disposable artifacts
// from real content without guessing.

export function buildEntityAggregates(rows = []) {
