...
export function userCanEditContent(user) {
  return user.role === "superadmin" || user.role === "seo_manager";
}

export function userCanReview(user) {
  return user.role === "superadmin" || user.role === "seo_manager" || user.role === "business_owner";
}

export function userCanOwnerApprove(user) {
  return user.role === "business_owner" || user.role === "superadmin";
}
