...
export const LANDING_WORKSPACE_BLOCK_REGISTRY = Object.freeze([
  { id: "landing_hero", label: "Hero", renderTarget: "Top landing block", required: true, sourceFields: ["title", "hero.headline", "hero.textEmphasisPreset", "hero.surfaceTone"] },
  ...
  { id: "content_band", label: "Content Band", renderTarget: "Supporting copy block", required: false, sourceFields: ["contentBand.body", "contentBand.subtitle", "contentBand.textEmphasisPreset", "contentBand.surfaceTone"] },
  { id: "cta_band", label: "CTA Band", renderTarget: "Final call-to-action block", required: false, sourceFields: ["ctaVariant", "ctaBand.title", "ctaBand.body", "ctaBand.note", "ctaBand.textEmphasisPreset", "ctaBand.surfaceTone"] }
]);
