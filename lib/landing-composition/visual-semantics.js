...
export const LANDING_RENDER_SLOT_KEYS = Object.freeze({
  BODY_TEXT: "body_text",
  MEDIA_CAPTION: "media_caption"
});

export const LANDING_RENDER_SLOT_REGISTRY = Object.freeze({
  [LANDING_RENDER_SLOT_KEYS.BODY_TEXT]: Object.freeze({
    slotName: "body-text",
    role: "primary-copy"
  }),
  [LANDING_RENDER_SLOT_KEYS.MEDIA_CAPTION]: Object.freeze({
    slotName: "media-caption",
    role: "supporting-media-caption"
  })
});
...
export function resolveLandingRenderSlot(slotKey) {
  return LANDING_RENDER_SLOT_REGISTRY[slotKey] ?? null;
}

export function getLandingRenderSlotAttributes(slotKey) {
  const slot = resolveLandingRenderSlot(slotKey);
  ...
  return {
    "data-public-render-slot": slot.slotName
  };
}
