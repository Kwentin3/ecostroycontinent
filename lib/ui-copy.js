...
export const AUDIT_EVENT_LABELS = {
  ...
  [AUDIT_EVENT_KEYS.REVIEW_DUPLICATE_REQUESTED]: "Версия уже на проверке",
  [AUDIT_EVENT_KEYS.REVIEW_SUPERSEDED]: "Заявка на проверку заменена",
  [AUDIT_EVENT_KEYS.PUBLISH_BLOCKED]: "Публикация заблокирована",
  [AUDIT_EVENT_KEYS.PUBLISHED]: "Опубликовано",
  [AUDIT_EVENT_KEYS.UNPUBLISH_BLOCKED]: "Снятие с публикации заблокировано",
  [AUDIT_EVENT_KEYS.UNPUBLISHED]: "Снято с публикации",
  ...
  [AUDIT_EVENT_KEYS.REMOVAL_MARKED]: "Помечено на удаление",
  [AUDIT_EVENT_KEYS.REMOVAL_UNMARKED]: "Пометка удаления снята",
  [AUDIT_EVENT_KEYS.REMOVAL_SWEEP_ANALYZED]: "Помеченный граф проанализирован",
  [AUDIT_EVENT_KEYS.REMOVAL_SWEEP_BLOCKED]: "Очистка помеченного графа заблокирована",
  [AUDIT_EVENT_KEYS.REMOVAL_SWEEP_EXECUTED]: "Очистка помеченного графа выполнена",
...
export const FIELD_LABELS = {
  ...
  serviceAreaNote: "Примечание по зоне оказания",
  ...
  metaTitle: "Заголовок для поиска",
  ...
  ctaTitle: "Заголовок кнопки",
  ctaBody: "Текст кнопки",
...
export const ADMIN_COPY = {
  ...
  sendForReview: "Сохранить и отправить на проверку",
...
export const FEEDBACK_COPY = {
  ...
  reviewAlreadySubmitted: "Эта версия уже на проверке. Если забыли правку, измените карточку и отправьте новую версию.",
  reviewUpdated: "Новая версия отправлена на проверку. Предыдущая заявка заменена.",
  readyToPublish: "Материал готов к публикации.",
...
const LEGACY_COPY_MAP = new Map([
  ["Refine the landing page from canonical Page truth.", "Уточнить лендинг на основе страницы-источника."],
  ["Refine the landing page.", "Уточнить лендинг."],
  ["Refine the hero.", "Уточнить главный блок."],
  ["Generate candidate/spec", "Сгенерировать черновик."],
  ...
  ["Landing candidate passed verification.", "Кандидат лендинга прошёл проверку."],
  ["Service candidate passed verification.", "Кандидат услуги прошёл проверку."],
  ["Landing candidate generation failed.", "Не удалось сгенерировать черновик лендинга."],
  ["Landing candidate is blocked by verification.", "Черновик лендинга заблокирован проверкой."]
]);
