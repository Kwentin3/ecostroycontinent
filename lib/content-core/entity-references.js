...
// Executable cross-domain reference registry.
// Any new relation path must stay in sync with
// docs/engineering/CONTENT_DOMAIN_INTERACTION_CONTRACT_v1.md,
// schemas.js, readiness.js, and the public read-side helpers.
...
function collectPageReferences(payload = {}) {
  ...
  pushRefs(refs, ENTITY_TYPES.SERVICE, sourceRefs.serviceIds ?? payload.serviceIds, "sourceRefs.serviceIds");
