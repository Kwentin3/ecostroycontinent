...
const pageSectionSchema = z.discriminatedUnion("type", [
  ...
  pageSectionBaseSchema.extend({
    type: z.literal(PAGE_SECTION_TYPES.SERVICE_LIST),
    title: optionalNonEmptyString,
    body: optionalNonEmptyString,
    serviceIds: stringList
  }),
...
const serviceSchema = z.object({
  ...
  serviceArea: optionalNonEmptyString,
  serviceAreaNote: optionalNonEmptyString,
...
const pageSchema = z.object({
  ...
  sourceRefs: z.object({
    ...
    caseIds: stringList,
    galleryIds: stringList
  }).default({ primaryServiceId: "", primaryEquipmentId: "", serviceIds: [], caseIds: [], galleryIds: [] }),
  targeting: z.object({
...
export function getTopLevelFieldsForEntityType(entityType) {
  switch (entityType) {
    ...
    case ENTITY_TYPES.SERVICE:
      return ["slug", "title", "h1", "summary", "serviceScope", "serviceScopeDisplayMode", "serviceArea", "serviceAreaNote", "problemsSolved", "methods", "ctaVariant", "equipmentIds", "relatedCaseIds", "galleryIds", "primaryMediaAssetId"];
    case ENTITY_TYPES.EQUIPMENT:
