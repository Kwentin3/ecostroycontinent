...
export function getTopLevelFieldsForEntityType(entityType) {
  switch (entityType) {
    ...
    case ENTITY_TYPES.SERVICE:
      return ["slug", "title", "h1", "summary", "serviceScope", "serviceArea", "serviceAreaNote", "problemsSolved", "methods", "ctaVariant", "equipmentIds", "relatedCaseIds", "galleryIds", "primaryMediaAssetId"];
    case ENTITY_TYPES.EQUIPMENT:
