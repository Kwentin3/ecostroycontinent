...
export const ENTITY_TYPE_LABELS = {
  ...
  [ENTITY_TYPES.EQUIPMENT]: "Техника",
...
export const PAGE_TYPES = {
  ...
  EQUIPMENT_LANDING: "equipment_landing"
};
...
export const SERVICE_SCOPE_DISPLAY_MODES = Object.freeze({
  DEFAULT: "default",
  COLUMNS: "columns"
});

export const PAGE_CREATE_MODES = {
  STANDALONE: "standalone",
  FROM_SERVICE: "from_service",
  FROM_EQUIPMENT: "from_equipment",
  CLONE_ADAPT: "clone_adapt"
};
...
export const AUDIT_EVENT_KEYS = {
  ...
  REVIEW_DUPLICATE_REQUESTED: "review_duplicate_requested",
  REVIEW_SUPERSEDED: "review_superseded",
  PUBLISH_BLOCKED: "publish_blocked",
  PUBLISHED: "published",
  UNPUBLISH_BLOCKED: "unpublish_blocked",
  ...
  SAFE_DELETE_BLOCKED: "safe_delete_blocked",
  SAFE_DELETE_EXECUTED: "safe_delete_executed",
  LIVE_DEACTIVATION_BLOCKED: "live_deactivation_blocked",
  REMOVAL_MARKED: "removal_marked",
  REMOVAL_UNMARKED: "removal_unmarked",
  REMOVAL_SWEEP_ANALYZED: "removal_sweep_analyzed",
  REMOVAL_SWEEP_BLOCKED: "removal_sweep_blocked",
  REMOVAL_SWEEP_EXECUTED: "removal_sweep_executed",
  TEST_GRAPH_TEARDOWN_BLOCKED: "test_graph_teardown_blocked",
  TEST_GRAPH_TEARDOWN_EXECUTED: "test_graph_teardown_executed",
