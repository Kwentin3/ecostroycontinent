...
const PLACEHOLDER_SERVICES = Object.freeze([
  {
    ...
    summary: "Временная техническая карточка для проверки маршрутов, навигации и CTA-сценариев.",
  ...
  },
  {
    ...
    summary: "Временная карточка для проверки route-to-route связности в сервисном контуре.",
  ...
  },
  {
    ...
    summary: "Технический stub для проверки переходов между услугами, кейсами и контактным действием.",
...
const PLACEHOLDER_GLOBAL_SETTINGS = Object.freeze({
  ...
  defaultCtaDescription: "Технический placeholder для проверки навигации и конверсионного пути."
});
...
const PLACEHOLDER_ABOUT_PAGE = Object.freeze({
  ...
  title: "О компании (placeholder)",
  h1: "О компании Экостройконтинент",
  intro: "Временная страница для проверки структуры маршрутов до готовности реального launch-контента.",
  ...
  sections: [
    {
      ...
      body: "Эта публикация служит только для проверки связности навигации и не является launch-контентом."
    },
    {
...
const PLACEHOLDER_CONTACTS_PAGE = Object.freeze({
  ...
  title: "Контакты (placeholder)",
  h1: "Контакты Экостройконтинент",
  intro: "Временная contact surface для проверки CTA-пути до появления подтверждённого published набора.",
  pageThemeKey: "earth_sand",
  mediaSettings: {},
  sections: [
    {
      ...
      order: 0,
      title: "Как связаться",
      body: "Технический placeholder: проверьте, что переходы и CTA отрабатывают корректно."
    },
    {
      type: PAGE_SECTION_TYPES.CTA,
      order: 1,
