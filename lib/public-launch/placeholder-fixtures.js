...
const PLACEHOLDER_HOME_PAGE = Object.freeze({
  entityId: "placeholder_page_home",
  revisionId: "placeholder_rev_page_home",
  slug: "home",
  pageType: PAGE_TYPES.HOME,
  title: "Главная (заглушка)",
  h1: "Экостройконтинент",
  intro: "Временная главная страница для проверки каноничного хаба услуг.",
  ...
  sections: [
    {
      ...
      order: 0,
      title: "О компании",
      body: "Главная собирает общий профиль компании и ведет посетителя к опубликованным услугам."
    },
    {
      type: PAGE_SECTION_TYPES.SERVICE_LIST,
      order: 1,
      title: "Услуги",
      body: "Список услуг берется из опубликованного контура.",
      serviceIds: []
    },
    {
      ...
      order: 2,
      title: "Следующий шаг",
      body: "Оставьте заявку или откройте нужную услугу.",
      ctaLabel: "Связаться"
    }
  ],
  sourceRefs: {},
...
export function getPlaceholderHomePage() {
  return clone(PLACEHOLDER_HOME_PAGE);
}
