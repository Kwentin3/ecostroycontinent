...
const DISPLAY_MODE_META = Object.freeze({
  [PUBLIC_DISPLAY_MODES.PUBLISHED_ONLY]: {
    label: "Только опубликованное",
    description: "Показывать только опубликованный контент без подстановки заглушек."
  },
  [PUBLIC_DISPLAY_MODES.MIXED_PLACEHOLDER]: {
    label: "Опубликованное с заглушкой",
    description: "Показывать опубликованный контент, а при отсутствии использовать маршрутную заглушку."
  },
  [PUBLIC_DISPLAY_MODES.UNDER_CONSTRUCTION]: {
    label: "Режим подготовки",
    description: "Единый режим удержания для публичных маршрутов ядра запуска."
  }
});
